    ...
    return (
        <div className=" col-xl-6 col-md-8 mx-auto my-5">
            ...
            <div className=" eventRegArea">
                ...
                <h2 className='fw-bold text-center mt-4'>Registration Form</h2>
                ...
                <div className=" text-center mt-3">
                    <button onClick={handleRegSubmit} className="btn btn-outline-secondary px-5 fw-bold fs-5" type="submit">Save</button>
                </div>
            </div>

            {enablePayment && <>
                <EventRegistraionDataView></EventRegistraionDataView>
            </>}
        </div >
    );
};

export default EventRegistraionPage;