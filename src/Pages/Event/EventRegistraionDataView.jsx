...
const EventRegistraionDataView = () => {
    ...
    const handleEventRegEdit = () => {
        setEnablePayment(false);
        navigate("/editEventReg");
    }


    return (
        <div className="col-xl-6 mx-auto my-5 regDataView ">
            <div className="container mx-auto ">
                <div className="row">
                    ...
                    {!enablePayment && <div className=" col-11 mx-auto">

                        <h4 className=" text-center fw-bold">Registrion Form Data</h4>

                        <h5 className=" text-center fw-bold float-end my-2">Registrion Status :
                            <Link onClick={setEnablePayment} className=" text-decoration-none"> Payment uncomplete</Link>
                        </h5>
                        ...
                        <div className="   text-center d-flex justify-content-center my-4">
                            <button onClick={handleEventRegEdit} className="btn btn-outline-secondary w-25 fs-5">Edit</button>
                            <button onClick={setEnablePayment} className="btn btn-outline-secondary w-25 fs-5 ms-3">Payment</button>
                        </div>
...
export default EventRegistraionDataView;